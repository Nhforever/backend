...
const ShowCart = (req, res) => {
    ...
    const user=100;
    const cart_id=userid+user;
    const sql2="SELECT a.*,b.*,c.* FROM cart_items a LEFT JOIN products b ON a.product_id = b.product_id LEFT JOIN pc_configs c ON a.product_id = c.product_id WHERE a.cart_id = ?;";
